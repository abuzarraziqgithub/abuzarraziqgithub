...
<h1 align="center">Hi 👋, I'm Abuzar RaziQ</h1>
...
- 📫 How to reach me **abuzarraziqo@gmail.com**
...
| React| Bootstrap | Tailwind | Axios
|----------|----------|----------|----------|----------|----------|----------|----------|
...
| Git | Postman | VBox | Gitlab | Node js | Slack
|----------|----------|----------|----------|----------|----------|----------|----------|
